...
1. حمّل المشروع (واستبدل `my-project` باسم مشروعك الفعلي - اكتب اسم المشروع باللغة الإنجليزية):
   ```bash
   git clone https://github.com/YOUR_USERNAME/ag-launchpad-ar.git my-project
   cd my-project
   ```
   > 💡 **تنبيه:** تأكد من تغيير اسم المجلد `my-project` إلى اسم مشروعك الجديد باللغة الإنجليزية لتمييزه وتفادي التكرار في مشاريعك القادمة.
